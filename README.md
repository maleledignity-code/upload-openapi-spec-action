...
```sh
npm install git+ssh://git@github.com:maleledignity-code/upload-openapi-spec-action.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/maleledignity-code/upload-openapi-spec-action/issues) with questions, bugs, or suggestions.
